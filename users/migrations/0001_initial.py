...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_location', (
            ...
            ('timeStamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 24, 0, 0))),
        ))
        ...
        db.create_table(u'users_encounter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user', to=orm['django_facebook.FacebookCustomUser'])),
            ('encounter', self.gf('django.db.models.fields.related.OneToOneField')(related_name='encounter', unique=True, to=orm['django_facebook.FacebookCustomUser'])),
    ...
    models = {
        ...
        u'users.encounter': {
            ...
            'encounter': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'encounter'", 'unique': 'True', 'to': u"orm['django_facebook.FacebookCustomUser']"}),
            'encounterLoc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'encounterLoc'", 'to': u"orm['users.Location']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user'", 'to': u"orm['django_facebook.FacebookCustomUser']"}),
        ...
        u'users.location': {
            ...
            'timeStamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 24, 0, 0)'}),
